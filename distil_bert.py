...
Original file is located at
    https://colab.research.google.com/drive/1GaDgaFdfzEkeTaU0dzCjC84ke0i2U7Qf
...
output_directory = '/content/drive/MyDrive/fine_tuned_model_half'
...
model.save_pretrained('/content/drive/MyDrive/fine_tuned_model_half')
tokenizer.save_pretrained('/content/drive/MyDrive/fine_tuned_model_half')

from transformers import pipeline

checkpoint = "/content/drive/MyDrive/fine_tuned_model_half/checkpoint-5265"
